...
async def mp3(event, msg):
    ...
    try:
        DT = time.time()
        await fast_download(name, file, Drone, edit, DT, "**Dᴏᴡɴʟᴏᴀᴅɪɴɢ**")
    ...
    try:
        UT = time.time()
        uploader = await fast_upload(f'{out}.mp3', f'{out}.mp3', UT, Drone, edit, '**Uᴘʟᴏᴀᴅɪɴɢ**')
        await Drone.send_file(event.chat_id, uploader, thumb=JPG, caption=f'**© @{BOT_UN}**', force_document=True)
    except Exception as e:
        os.rmdir("audioconvert")
        print(e)
...
async def flac(event, msg):
    ...
    try:
        UT = time.time()
        uploader = await fast_upload(f'{out}.flac', f'{out}.flac', UT, Drone, edit, '**Uᴘʟᴏᴀᴅɪɴɢ**')
        await Drone.send_file(event.chat_id, uploader, thumb=JPG, caption=f'**© @{BOT_UN}**', force_document=True)
    except Exception as e:
        os.rmdir("audioconvert")
        print(e)
...
async def wav(event, msg):
    ...
    try:
        UT = time.time()
        uploader = await fast_upload(f'{out}.wav', f'{out}.wav', UT, Drone, edit, '**Uᴘʟᴏᴀᴅɪɴɢ**')
        await Drone.send_file(event.chat_id, uploader, thumb=JPG, caption=f'**© @{BOT_UN}**', force_document=True)
    except Exception as e:
        os.rmdir("audioconvert")
        print(e)
...
async def mp4(event, msg):
    ...
    try:
        UT = time.time()
        uploader = await fast_upload(f'{out}.mp4', f'{out}.mp4', UT, Drone, edit, '**Uᴘʟᴏᴀᴅɪɴɢ**')
        await Drone.send_file(event.chat_id, uploader, thumb=JPG, caption=f'**© @{BOT_UN}**', force_document=True)
    except Exception as e:
        print(e)
        return await edit.edit(f"An error occured while uploading!\n\nContact [SUPPORT]({SUPPORT_LINK})")
...
async def mkv(event, msg):
    ...
    try:
        UT = time.time()
        uploader = await fast_upload(f'{out}', f'{out}', UT, Drone, edit, '**Uᴘʟᴏᴀᴅɪɴɢ**')
        await Drone.send_file(event.chat_id, uploader, thumb=JPG, caption=f'**© @{BOT_UN}**', force_document=True)
    except Exception as e:
        print(e)
        return await edit.edit(f"An error occured while uploading!\n\nContact [SUPPORT]({SUPPORT_LINK})")
...
async def file(event, msg):
    ...
    try:
        UT = time.time()
        uploader = await fast_upload(f'{name}', f'{name}', UT, Drone, edit, '**Uᴘʟᴏᴀᴅɪɴɢ**')
        await Drone.send_file(event.chat_id, uploader, thumb=JPG, caption=f'**© @{BOT_UN}**', force_document=True)
    except Exception as e:
        print(e)
        return await edit.edit(f"An error occured while uploading!\n\nContact [SUPPORT]({SUPPORT_LINK})")
...
async def video(event, msg):
    ...
    try:
        ...
        UT = time.time()
        uploader = await fast_upload(f'{out}', f'{out}', UT, Drone, edit, '**Uᴘʟᴏᴀᴅɪɴɢ**')
        await Drone.send_file(event.chat_id, uploader, thumb=JPG2, caption=f'**© @{BOT_UN}**', attributes=attributes, force_document=False)
    except Exception as e:
        print(e)
        return await edit.edit(f"An error occured while uploading!\n\nContact [SUPPORT]({SUPPORT_LINK})")
    await edit.delete()
